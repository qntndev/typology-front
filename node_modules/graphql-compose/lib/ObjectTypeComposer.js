...
class ObjectTypeComposer {
  ...
  getType() {
    if (_graphqlVersion.graphqlVersion >= 14) {
      this._gqType._fields = () => (0, _configToDefine.defineFieldMap)(this._gqType, (0, _misc.mapEachKey)(this._gqcFields, (fc, name) => this.getFieldConfig(name)));
      ...
      this._gqType._typeConfig.interfaces = () => this._gqcInterfaces.map(i => i.getType());
