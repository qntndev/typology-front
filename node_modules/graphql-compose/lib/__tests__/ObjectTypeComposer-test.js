...
describe('ObjectTypeComposer', () => {
  ...
  describe('fields manipulation', () => {
    ...
    describe('setFields()', () => {
      ...
      it('accept fieldConfig as function', () => {
        ...
        expect(tc.getFieldArgType('input4', 'a')).toBe(_graphql.GraphQLInt);
        expect(tc.getField('input4').resolve()).toBe(123);
      });
    });
    it('addFields()', () => {
      tc.addFields({
  ...
  describe('clone()', () => {
    it('should clone projection for fields', () => {
      ...
      expect(fc.projection).toEqual({
        field1: true,
        field2: true
      });
      expect(fc.type.getType()).toBe(_graphql.GraphQLString);
    });
  });
  describe('get()', () => {
